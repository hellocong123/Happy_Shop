package com.cong.happy_shop.utils;
...
public class Constants {
   // http://10.0.217.110:8080/atguigu/json/DIGIT_URL.json
   // http://10.0.217.110:8080/atguigu/img/

    //    public static final String BASE = "http://192.168.51.104:8080";
    //系统默认的模拟器就用这个ip
    public static final String BASE = "http://192.168.1.105:8080";
    //使用第三方模拟器--当前电脑的ip地址
//    public static final String BASE = "http://192.168.51.104:8080";
    //运行到自己的真实手机上：
